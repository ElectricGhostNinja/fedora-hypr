...
hl.bind(mainMod .. " + CONTROL + Tab",           hl.dsp.group.next())
hl.bind(mainMod .. " + CONTROL + SHIFT + Tab",   hl.dsp.group.prev())
hl.bind(mainMod .. " + SHIFT + H",               hl.dsp.group.lock({ action = "toggle" }))

-- Keep floating windows on top / centered
...
hl.bind(mainMod .. " + SHIFT + J",  hl.dsp.exec_cmd("xdg-open http://localhost:8096"))
