...
-- Cargo-installed binaries (e.g. yazi) live outside the default session PATH
if not os.getenv("PATH"):find("/home/ghost/.cargo/bin", 1, true) then
    hl.env("PATH", os.getenv("PATH") .. ":/home/ghost/.cargo/bin")
end
